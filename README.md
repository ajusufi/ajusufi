...
**[deep-ml](https://github.com/ajusufi/deep-ml)** is my LeetCode-style practice log for machine learning. It contains solutions written by hand while I work through topics from university and build a stronger practical understanding of the theory.

`learn → implement → test → document → repeat`
...
<!--
When another project is ready, add it above the current-focus section using the
same structure as Deep-ML. Keep project covers monochrome, 1200 x 630, and use
real screenshots when the project has a visual interface.
-->
